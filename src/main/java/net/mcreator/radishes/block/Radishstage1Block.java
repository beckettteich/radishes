...
public class Radishstage1Block extends RadishesModElements.ModElement {
	@ObjectHolder("radishes:radishstage_1")
	public static final Block block = null;
	public Radishstage1Block(RadishesModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("radishstage_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("radishes:radishstage_1"), configuredFeature);
		}
	}
	@SubscribeEvent
